...
public class view_order_adapter extends RecyclerView.Adapter<view_order_adapter.viewHolder> {
    ...
    public view_order_adapter(Context context){
    ...
    @NonNull
    @Override
    public view_order_adapter.viewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new view_order_adapter.viewHolder(LayoutInflater.from(context).inflate(R.layout.view_order_adapter,null,false));

    }

    @Override
    public void onBindViewHolder(@NonNull final view_order_adapter.viewHolder viewHolder, final int i) {
