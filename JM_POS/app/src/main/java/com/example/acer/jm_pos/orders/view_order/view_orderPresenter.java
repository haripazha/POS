...
public class view_orderPresenter implements view_orderContract.viewOrder_presenter {
    //mvp declaration
    view_orderContract.viewOrder_view mView;
    Context context;
    ...
    view_orderPresenter(view_orderContract.viewOrder_view view){
        this.mView = view;
    ...
    public void getCustomer_orders() {
        ...
        StringRequest getCustomer_orders = new StringRequest(Request.Method.POST, localhost+main_orders, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                hashMap.put("function","getCustomer_orders");
