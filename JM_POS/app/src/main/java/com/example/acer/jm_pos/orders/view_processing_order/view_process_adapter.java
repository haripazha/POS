...
public class view_process_adapter extends RecyclerView.Adapter<view_process_adapter.viewHolder> {
    ...
    public view_process_adapter(Context context){
    ...
    @NonNull
    @Override
    public view_process_adapter.viewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new view_process_adapter.viewHolder(LayoutInflater.from(context).inflate(R.layout.view_order_adapter,null,false));

    }

    @Override
    public void onBindViewHolder(@NonNull final view_process_adapter.viewHolder viewHolder, final int i) {
