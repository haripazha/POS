...
public class home_viewPresenter implements home_viewContract.home_presenter {
    //mvp declaration
    home_viewContract.home_view mView;
    Context context;
    ...
    home_viewPresenter(home_viewContract.home_view view){
        this.mView = view;
    ...
    //Menu Item Function search
    @Override
    public void onMenu_search() {
